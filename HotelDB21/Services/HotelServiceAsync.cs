...
namespace HotelDBConsole21.Services
{
    public class HotelServiceAsync : Connection, IHotelServiceAsync
    {
        ...
        private const string InsertSql = "insert into Hotel values (@ID, @Name, @Address)";
        ...
        public async Task<Hotel> GetHotelFromIdAsync(int hotelNo)
        {
            await using var connection = new SqlConnection(ConnectionString);
        ...
        public async Task<bool> UpdateHotelAsync(Hotel hotel, int hotelNo)
        {
            await using var connection = new SqlConnection(ConnectionString);
        ...
        public async Task<Hotel> DeleteHotelAsync(int hotelNo)
        {
            await using var connection = new SqlConnection(ConnectionString);
            ...
            try
            {
                ...
                var hotel = GetHotelFromIdAsync(hotelNo).Result;
